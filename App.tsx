...
import { parseScenario } from './services/geminiService';
import { simulateRisk } from './services/inventoryEngine';
import { ScenarioParameters, IngredientRisk } from './types';
...
const App: React.FC = () => {
  ...
  const [params, setParams] = useState<ScenarioParameters | null>(null);
  const [inventory, setInventory] = useState<IngredientRisk[]>([]);
  ...
  const handleRunSimulation = useCallback(async (scenario: string) => {
    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex flex-col relative">
        ...
        <main className="p-10 space-y-12 max-w-[1400px]">
          {/* Top Section: Scenario Orchestrator */}
          ...
          {/* Bottom Section: Strategic Outlook (Maintained Aesthetic) */}
